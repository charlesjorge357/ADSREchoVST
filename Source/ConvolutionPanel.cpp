...
ConvolutionPanel::ConvolutionPanel()
{
    ...
    setupValueLabel(irGainValue);
    setupValueLabel(lowCutValue);
    setupValueLabel(highCutValue);
    ...
    bindValue(irGainSlider, irGainValue, 1, "dB");
    bindValue(lowCutSlider, lowCutValue, 0, "Hz");
    bindValue(highCutSlider, highCutValue, 0, "Hz");
    bindValue(preDelaySlider, preDelayValue, 1, "ms");
...
void ConvolutionPanel::resized()
{
    ...
    auto placeKnob = [&](juce::Label& label, juce::Slider& slider, juce::Label& valueLabel, int col, int row)
    {
    ...
    placeKnob(irGainLabel,   irGainSlider, irGainValue,   0, 0);
